...
export function highlightPlane(scene, block){
    const geometry = new THREE.PlaneGeometry(block[0].geometry.parameters.width, block[0].geometry.parameters.depth);
    ...
    plane.position.set(block[1][0][0], 0, block[1][0][2]);
    return plane;
}
